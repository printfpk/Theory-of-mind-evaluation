...
export default function Dashboard() {
  const stats = [
    { title: "Total Experiments", value: "42", change: "+12%", isNegative: false, icon: <Activity className="text-blue-400" size={24}/> },
    { title: "Average Accuracy", value: "78.4%", change: "+3.2%", isNegative: false, icon: <Target className="text-emerald-400" size={24}/> },
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button className="flex justify-center items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-5 py-2.5 rounded-lg font-medium transition-all shadow-[0_0_15px_rgba(37,99,235,0.2)] active:scale-95 text-sm">
